...
<br>
<br>
 <h2><strong><p>Πιο αναλυτικά, θέλουμε να φτιάξουμε ένα σύστημα στο  οποίο ο χρήστης να εισάγει τις ώρες και τις ημέρες που χρειάζεται να παίρνει την φαρμακευτική του αγωγή. Το σύστημα με τη σειρά του να τον ειδοποιεί τις κατάλληλες ώρες την εκάστοτε μέρα γι αυτή, βοηθώντας στην υπενθύμιση της στον χρήστη, κρατώντας τον αυτόνομο. </p></strong></h2>
